...
<head>
	...
	body {
		...
		color: #fff;
		background: #aa0000 url(http://www.afrihost.com/imgpage_comingsoon.jpg) repeat-x center top;
	}
	...
	#logo a {
		...
		width: 200px;
		text-indent: -9999px;
		background: url(http://www.afrihost.com/imghead_logo_inv.png) no-repeat left bottom;
	}
	...
	width: 131px;
	height: 34px;
	background: url(http://www.afrihost.com/imgbtn_visit.png) no-repeat left top;
	margin-top: 50px;
	}
    ...
    <script type="text/javascript" src="http://www.afrihost.com/site/jstypeface.js"></script>
    <script type="text/javascript" src="http://www.afrihost.com/site/jsltv_lig.js"></script>
    <script type="text/javascript" src="http://www.afrihost.com/site/jsltv_med.js"></script>
</head>
